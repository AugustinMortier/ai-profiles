...
# Encoder
input_img = Input(shape=(256, 512, 1))  # Input shape for grayscale images
...
x = Conv2D(32, (3, 3), activation='relu', padding='same')(x) # 128, 256, 128
x = UpSampling2D((2, 2))(x) # 256, 512, 128
decoded = Conv2D(1, (3, 3), activation='sigmoid', padding='same')(x)  # Output shape for grayscale: 256, 512, 1
...
print(f"Encoded images shape: {encoded_images.shape}")  # Expected (32, 64, 128) for example
